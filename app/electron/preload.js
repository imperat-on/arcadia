...
contextBridge.exposeInMainWorld("launcherAPI", {
  ...
  steamContaStatus: () => ipcRenderer.invoke("steam:contaStatus"),
  steamVincularConta: () => ipcRenderer.invoke("steam:vincularConta"),
  steamCapturarAgora: () => ipcRenderer.invoke("steam:capturarAgora"),
  steamHorasDoJogo: (appid) => ipcRenderer.invoke("steam:horasDoJogo", appid),
