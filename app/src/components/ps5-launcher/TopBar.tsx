...
interface TopBarProps { profile?: Profile; activeTab:number; onTab:(i:number)=>void; onRefresh:()=>void; onOpenProfile:()=>void; menuOpen:boolean; onToggleMenu:()=>void; onCloseMenu:()=>void; showHidden:boolean; onToggleShowHidden:()=>void; onOpenSettings?:()=>void; libraryFilter?:LibraryFilter; onLibraryFilter?:(f:LibraryFilter)=>void; search?:string; onSearch?:(v:string)=>void }
...
export function TopBar({profile,activeTab,onTab,onRefresh,onOpenProfile,menuOpen,onToggleMenu,onCloseMenu,showHidden,onToggleShowHidden,onOpenSettings,libraryFilter="all",onLibraryFilter,search="",onSearch}:TopBarProps){
