...
interface TopBarProps { profile?: Profile; activeTab:number; onTab:(i:number)=>void; onRefresh:()=>void; onOpenDownloads:()=>void; onOpenProfile:()=>void; menuOpen:boolean; onToggleMenu:()=>void; onCloseMenu:()=>void; showHidden:boolean; onToggleShowHidden:()=>void; libraryFilter?:LibraryFilter; onLibraryFilter?:(f:LibraryFilter)=>void; search?:string; onSearch?:(v:string)=>void }
...
export function TopBar({profile,activeTab,onTab,onRefresh,onOpenDownloads,onOpenProfile,menuOpen,onToggleMenu,onCloseMenu,showHidden,onToggleShowHidden,libraryFilter="all",onLibraryFilter,search="",onSearch}:TopBarProps){
