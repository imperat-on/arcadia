...
export function LaunchModeDialog({
  ...
  const Opcao = ({ mode, titulo, desc }: { mode: "steam" | "exe"; titulo: string; desc: string }) => (
    <button
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <p className="mb-5 text-[13px] text-white/70">{t("launchmode.subtitulo", { name: game.title })}</p>

        <div className="flex flex-col gap-3">
          <Opcao mode="steam" titulo={t("launchmode.steam_titulo")} desc={t("launchmode.steam_desc")} />
