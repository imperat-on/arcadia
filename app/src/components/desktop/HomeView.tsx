    ...
    <div className={`desktop-retro-home h-full bg-[#08080a] ${pagina ? "overflow-hidden" : "overflow-y-auto"}`}>
      {pagina ? (
        ...
        <>
          ...
          <div className="desktop-classic-home-grid px-8 py-6">
...
function HomeHero({ jogo, onOpen }: { jogo: ItemLoja; onOpen: () => void }) {
  ...
  return (
    <button onClick={onOpen} className="desktop-classic-home-hero relative block h-[44vh] min-h-[330px] w-full overflow-hidden bg-black text-left">
      <img
        src={hero}
        alt=""
        decoding="async"
