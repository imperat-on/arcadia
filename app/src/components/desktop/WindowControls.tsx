...
// Barra de título própria do modo desktop: faixa fina arrastável no topo com o
// semáforo estilo macOS (fechar vermelho · minimizar amarelo · maximizar verde),
// à esquerda. A janela é frameless (ver createWindow em main.js), então estes
// substituem os controles do sistema. O glyph de cada bolinha só aparece no
// hover do grupo, como no macOS.
export function WindowControls() {
  ...
  return (
    <div
      className="fixed left-0 top-0 z-[100] flex h-9 items-center px-4"
