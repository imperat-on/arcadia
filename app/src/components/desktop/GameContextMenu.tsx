      ...
      {verCategorias ? (
        <>
          ...
          <div className="max-h-[220px] overflow-y-auto">
            {allCategories.length === 0 && <p className="px-4 py-2 text-[12px] text-white/35">Nenhuma categoria ainda.</p>}
            {allCategories.map((c) => (
        ...
        <>
          ...
          <Item
            ...
            label="Registros"
          />
          <Item onClick={run(actions.editar)} icon={I("M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a1 1 0 000-1.41l-2.34-2.34a1 1 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z")} label="Editar App/Jogo" />
          <Item onClick={run(actions.metadados)} icon={I("M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z")} label="Metadados" />
          <Item onClick={run(actions.ocultar)} icon={I("M12 7a5 5 0 015 5c0 .65-.13 1.26-.36 1.83l2.92 2.92A11.8 11.8 0 0023 12c-1.73-4.39-6-7.5-11-7.5-1.27 0-2.49.2-3.64.57l2.17 2.16C11.1 7.09 11.54 7 12 7zM2.71 3.16L1.39 4.47l2.17 2.17A11.77 11.77 0 001 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l3.15 3.15 1.31-1.31L2.71 3.16zM12 17a5 5 0 01-4.55-7.06l1.55 1.55A3 3 0 0012 15c.28 0 .55-.04.8-.11l1.55 1.55c-.72.36-1.51.56-2.35.56z")} label="Ocultar jogo" />
          <Item onClick={run(actions.favorito)} icon={I(game.favorite ? "M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" : "M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z")} label={game.favorite ? "Remover dos favoritos" : "Adicionar aos favoritos"} />
          <Item onClick={() => setVerCategorias(true)} icon={I("M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z")} label="Categorias" />
          {game.installed !== false && (
            <Item onClick={run(actions.desinstalar)} icon={I("M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z")} label="Desinstalar" />
          )}
